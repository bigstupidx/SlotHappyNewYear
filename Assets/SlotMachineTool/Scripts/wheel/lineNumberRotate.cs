...
/*		case "bet_label_02":
		...
		m_linewheel = GameObject.Find ("UI Root/Stretch/UserPanel/SelectWheel").GetComponent<LineWheel>();
		m_Label_01 = GameObject.Find ("UI Root/Stretch/UserPanel/SelectWheel/SelectLine/Line_Selection/line_label_01").GetComponent<UILabel>();
		m_Label_02 = GameObject.Find ("UI Root/Stretch/UserPanel/SelectWheel/SelectLine/Line_Selection/line_label_02").GetComponent<UILabel>();
		m_Label_03 = GameObject.Find ("UI Root/Stretch/UserPanel/SelectWheel/SelectLine/Line_Selection/line_label_03").GetComponent<UILabel>();
		m_Label_04 = GameObject.Find ("UI Root/Stretch/UserPanel/SelectWheel/SelectLine/Line_Selection/line_label_04").GetComponent<UILabel>();
		m_Label_05 = GameObject.Find ("UI Root/Stretch/UserPanel/SelectWheel/SelectLine/Line_Selection/line_label_05").GetComponent<UILabel>();
		m_Label_06 = GameObject.Find ("UI Root/Stretch/UserPanel/SelectWheel/SelectLine/Line_Selection/line_label_06").GetComponent<UILabel>();
		m_Label_07 = GameObject.Find ("UI Root/Stretch/UserPanel/SelectWheel/SelectLine/Line_Selection/line_label_07").GetComponent<UILabel>();
		m_Label_08 = GameObject.Find ("UI Root/Stretch/UserPanel/SelectWheel/SelectLine/Line_Selection/line_label_08").GetComponent<UILabel>();
